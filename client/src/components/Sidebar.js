  ...
  return (
    <div className="w-full h-full grid grid-cols-[48px,1fr] bg-white">
          <div className="bg-slate-200 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-600 flex flex-col justify-between" >
                <div>
                      <NavLink className={({isActive})=>`w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-300 rounded ${isActive && 'bg-slate-200'}` }title="chat">
                    <BsChatDots size={20} />
                  </NavLink>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <button title='logout' className="w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-300 rounded" onClick={handelLogout}>
                        <span className=' -ml-2'>
                          <CiLogout size={20}/>
                        </span>
                    </button>
